...
export function CopyLinkButton({ kudosId }: CopyLinkButtonProps) {
  ...
  return (
    ...
    >
      {copied ? (
        <span className="font-[family-name:var(--font-montserrat)] font-bold text-[14px] leading-5">✓ Copied</span>
      ) : (
        <span className="flex items-center gap-1 font-[family-name:var(--font-montserrat)] font-bold text-[14px] leading-5 text-[var(--color-kudos-text)]">
          Copy Link
